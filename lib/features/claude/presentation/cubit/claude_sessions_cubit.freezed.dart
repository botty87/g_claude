...
mixin _$ClaudeSessionData {
 ...
 List<ClaudeMessage> get messages; ClaudeRunStatus get runStatus; ClaudeModel get model; ClaudePermissionMode get permissionMode; String? get claudeSessionId; Failure? get lastError; List<String> get stderrTail;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ClaudeSessionData&&const DeepCollectionEquality().equals(other.messages, messages)&&(identical(other.runStatus, runStatus) || other.runStatus == runStatus)&&(identical(other.model, model) || other.model == model)&&(identical(other.permissionMode, permissionMode) || other.permissionMode == permissionMode)&&(identical(other.claudeSessionId, claudeSessionId) || other.claudeSessionId == claudeSessionId)&&(identical(other.lastError, lastError) || other.lastError == lastError)&&const DeepCollectionEquality().equals(other.stderrTail, stderrTail));
}


@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(messages),runStatus,model,permissionMode,claudeSessionId,lastError,const DeepCollectionEquality().hash(stderrTail));

@override
String toString() {
  return 'ClaudeSessionData(messages: $messages, runStatus: $runStatus, model: $model, permissionMode: $permissionMode, claudeSessionId: $claudeSessionId, lastError: $lastError, stderrTail: $stderrTail)';
}
...
@useResult
$Res call({
 List<ClaudeMessage> messages, ClaudeRunStatus runStatus, ClaudeModel model, ClaudePermissionMode permissionMode, String? claudeSessionId, Failure? lastError, List<String> stderrTail
});
...
/// Create a copy of ClaudeSessionData
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? messages = null,Object? runStatus = null,Object? model = null,Object? permissionMode = null,Object? claudeSessionId = freezed,Object? lastError = freezed,Object? stderrTail = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<ClaudeMessage> messages,  ClaudeRunStatus runStatus,  ClaudeModel model,  ClaudePermissionMode permissionMode,  String? claudeSessionId,  Failure? lastError,  List<String> stderrTail)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ClaudeSessionData() when $default != null:
return $default(_that.messages,_that.runStatus,_that.model,_that.permissionMode,_that.claudeSessionId,_that.lastError,_that.stderrTail);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<ClaudeMessage> messages,  ClaudeRunStatus runStatus,  ClaudeModel model,  ClaudePermissionMode permissionMode,  String? claudeSessionId,  Failure? lastError,  List<String> stderrTail)  $default,) {final _that = this;
switch (_that) {
case _ClaudeSessionData():
return $default(_that.messages,_that.runStatus,_that.model,_that.permissionMode,_that.claudeSessionId,_that.lastError,_that.stderrTail);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<ClaudeMessage> messages,  ClaudeRunStatus runStatus,  ClaudeModel model,  ClaudePermissionMode permissionMode,  String? claudeSessionId,  Failure? lastError,  List<String> stderrTail)?  $default,) {final _that = this;
switch (_that) {
case _ClaudeSessionData() when $default != null:
return $default(_that.messages,_that.runStatus,_that.model,_that.permissionMode,_that.claudeSessionId,_that.lastError,_that.stderrTail);case _:
  return null;
...
class _ClaudeSessionData implements ClaudeSessionData {
  const _ClaudeSessionData({final  List<ClaudeMessage> messages = const <ClaudeMessage>[], this.runStatus = ClaudeRunStatus.idle, required this.model, required this.permissionMode, this.claudeSessionId, this.lastError, final  List<String> stderrTail = const <String>[]}): _messages = messages,_stderrTail = stderrTail;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ClaudeSessionData&&const DeepCollectionEquality().equals(other._messages, _messages)&&(identical(other.runStatus, runStatus) || other.runStatus == runStatus)&&(identical(other.model, model) || other.model == model)&&(identical(other.permissionMode, permissionMode) || other.permissionMode == permissionMode)&&(identical(other.claudeSessionId, claudeSessionId) || other.claudeSessionId == claudeSessionId)&&(identical(other.lastError, lastError) || other.lastError == lastError)&&const DeepCollectionEquality().equals(other._stderrTail, _stderrTail));
}


@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_messages),runStatus,model,permissionMode,claudeSessionId,lastError,const DeepCollectionEquality().hash(_stderrTail));
...
/// Create a copy of ClaudeSessionData
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? messages = null,Object? runStatus = null,Object? model = null,Object? permissionMode = null,Object? claudeSessionId = freezed,Object? lastError = freezed,Object? stderrTail = null,}) {
